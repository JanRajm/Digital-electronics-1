...
begin
    ...
    p_stimulus : process
    begin
        s_velocity <= "000000000";
        wait for 10 ns;
        s_velocity <= "000001010";
        wait for 10 ns;
        s_velocity <= "000001100";
        wait for 10 ns;
        s_velocity <= "000001110";
        wait for 10 ns;
        s_velocity <= "000011001";
        wait for 10 ns;
        s_velocity <= "000001000";
        wait for 10 ns;
        s_velocity <= "000001010";
        wait for 10 ns;
        s_velocity <= "000001010";
